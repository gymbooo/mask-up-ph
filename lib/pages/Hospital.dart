...
class _HospitalState extends State<Hospital> {
  ...
  Future<String> getNewNearby(newLat, newLng) async {
    var response = await http.get(
        Uri.encodeFull(
            'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=$newLat,$newLng&radius=2000&keyword=covid+test&key=AIzaSyDmGhS77Xm9peRvlmiPYGF4vYOZQrV0ei0'),
                  ...
                  children: [
                    SearchMapPlaceWidget(
                      ...
                      onSelected: (Place place) async {
                        ...
                        var newLat = geolocation.coordinates.latitude;
                        var newLng = geolocation.coordinates.longitude;
                        getNewNearby(newLat, newLng);
                      },
                    ),
                    Container(
